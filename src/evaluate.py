...
def evaluate(model, dataset_name, normal_class, output_name, indexes, data_path):
    ...
    ref_dataset = load_dataset(dataset_name, indexes, normal_class, True, data_path, download_data=False)
    test = load_dataset(dataset_name, indexes, normal_class, False, data_path, download_data=False)
...
if __name__ == '__main__':
    ...
    evaluate(model, dataset, normal_class, output_name, indexes, data_path )
